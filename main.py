...
def _do_analysis(symbol: str, name: str) -> str:
    ...
    prompt = f"""資深股票分析師，根據以下真實數據撰寫分析。每項帶數值，禁空話，禁 Markdown 表格。
...
---
請以繁體中文撰寫，總字數 1100 字以內，以下八節全部完整輸出，每節不得省略：

**📊 近期走勢**（2-3句：行情概述＋主要漲跌原因）
